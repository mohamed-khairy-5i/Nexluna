...
UNITS = {
    ...
    "area": [("km2", "كم مربع"), ("m2", "متر مربع"), ("cm2", "سم مربع"), ("ha", "هكتار"),
             ("feddan", "فدّان (مصري)"), ("kirat", "قيراط"), ("sahm", "سهم"), ("dunam", "دونم متري"),
             ("acre", "أكر"), ("ft2", "قدم مربع"), ("in2", "إنش مربع"), ("mi2", "ميل مربع")],
    "volume": [("m3", "متر مكعب"), ("L", "لتر"), ("mL", "مليلتر"), ("gal", "جالون أمريكي"),
    ...
    "fuel": [("kml", "كم/لتر"), ("l100", "لتر/100كم"), ("mpg", "ميل/جالون أمريكي"),
