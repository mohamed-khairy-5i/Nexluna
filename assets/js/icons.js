...
(function () {
  ...
  var ICONS = {
    ...
    linkedin: '<rect x="3" y="3" width="18" height="18" rx="2" ' + P + '/><path fill="currentColor" stroke="none" d="M7.2 9.5h1.9v7.3H7.2zM8.15 6.4a1.1 1.1 0 1 1 0 2.2 1.1 1.1 0 0 1 0-2.2zM10.8 9.5h1.82v1h.03c.25-.48.87-.98 1.8-.98 1.92 0 2.28 1.26 2.28 2.9v3.38h-1.9v-3c0-.72-.01-1.64-1-1.64-1 0-1.15.78-1.15 1.59v3.05H10.8z"/>'
  };
